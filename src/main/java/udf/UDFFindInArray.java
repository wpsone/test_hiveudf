...
@Description(name = "udffindinarray",
    value = "_FUNC_(NEEDLE, HAYSTACK) - Find the first 1-indexed value of HAYSTACK which matches NEEDLE." +
            "Returns NULL if HAYSTACK is NULL. Returns 0 if NEEDLE is not found in HAYSTACK or is NULL.",
