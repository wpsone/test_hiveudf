...
@Description(name = "udfdayofweek",
    value = "_FUNC_(year,month,day) - Find the weekday of the date. Use four-day year (2011);January is month=1,January 1 is day=1." +
            "Also takes an array representing these.\n")
